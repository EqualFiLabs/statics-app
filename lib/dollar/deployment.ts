...
export function readClientDollarDeployment(): DollarDeploymentState {
  return readDollarDeployment({
    ...
    NEXT_PUBLIC_STATICS_POOL_MANAGER_ADDRESS:
      process.env.NEXT_PUBLIC_STATICS_POOL_MANAGER_ADDRESS,
    ...
    NEXT_PUBLIC_STATICS_STATE_VIEW_CODE_HASH:
      process.env.NEXT_PUBLIC_STATICS_STATE_VIEW_CODE_HASH,
  });
}
