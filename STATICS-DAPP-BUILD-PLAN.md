...
- [~] Desktop, tablet, and mobile implementation plus snapshot coverage is locally verified for the overview, Dollar, basket catalog/detail, PositionNFT catalog/detail, rewards, activity, and settings; explicit product approval remains pending.
- [ ] Design and approve the remaining loan, reward-claim, basket-creation, and canonical-liquidity surfaces before their functional implementation is treated as product-complete.
