  ...
  return (
    <div className="position-detail">
      ...
      <section className="position-panel position-rewards">
        ...
        <p className="dollar-warning">
          Reward claims are planned and remain disabled in this release. Pending balances are
          authoritative reads; selecting an asset never grants historical rewards.
        </p>
